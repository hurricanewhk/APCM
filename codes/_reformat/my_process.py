...
strategies = json.load(open('./CONFIG/strat.json'))
strategies = [e[1:-1] for e in strategies]
strat2id = {strat: i for i, strat in enumerate(strategies)}
print(args.add_persona)
#  /data/wanghongkai/ds/PAL-main/PESConv.json
if args.add_persona:
    original = json.load(open('/data/wanghongkai/ds/PAL-main/codes/processed_myPESC.json'))
else:
...
def process_data(d):
    ...
    # persona = d['persona']
    persona_list = d['acc_persona_list']
