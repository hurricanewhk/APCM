...
inputter = inputters[args.inputter_name](use_all_persona=args.use_all_persona,)
...
def freeze_blenderbot_parameters(model):
    for name, param in model.named_parameters():
        if "persona_cross_attn" not in name and "context_cross_attn" not in name and "fc" not in name:
...
# freeze_blenderbot_parameters(model)
...
output_dir = join(f'./DATA/{args.inputter_name}.{args.config_name}_persona_attention_final_rebuttal',    #_new_split_usr_sys',
