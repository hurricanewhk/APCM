...
class BucketingDataLoader(object):
    def __init__(self, toker, feature_dataset, batch_size,
        ...
        with open(f'./DATA/{inputter_name}.{config_name}_persona_attention_final_rebuttal/data_select.pkl', 'rb') as f:
            self.data = pickle.load(f)
        # with open('/data/wanghongkai/ds/PAL_V2/PAL-main/codes/DATA/strat.strat_persona_attention_final_rebuttal/data_select.pkl', 'rb') as f:
        #     self.data = pickle.load(f)
        # with open('/data/wanghongkai/ds/PAL-main/codes/DATA/strat.gated_encoder_model_persona_attention_final_rebuttal/data_select.pkl', 'rb') as f:
        #     self.data = pickle.load(f)
