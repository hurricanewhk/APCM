...
class Model(BaseModel, BlenderbotSmallForConditionalGeneration):
    def __init__(self, config: BlenderbotSmallConfig):
        ...
        self.strategy_alpha = nn.Parameter(torch.tensor([0, 0.75, 0, 0, 0.75, 0.75, 0.75, 0.375]))
    ...
    def predict_strategy(self, logits, encoded_info):
        ...
        assert 'pred_strat_id_top1' in encoded_info, "The key 'pred_strat_id_top1' is not found in the encoded_info dictionary."
        assert 'pred_strat_id_top2' in encoded_info, "The key 'pred_strat_id_top2' is not found in the encoded_info dictionary."
